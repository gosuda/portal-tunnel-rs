...
/// `POST /v1/sdk/renew`, and `POST /v1/sdk/unregister`. The
/// `/v1/sdk/connect` handler registers in a follow-up commit. See
/// the [`sdk`] module rustdoc for the per-endpoint contracts (auth
/// posture, CORS, etc.).
#[must_use]
#[expect(
