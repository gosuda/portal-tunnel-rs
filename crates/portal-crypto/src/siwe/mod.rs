...
//!
//! - **[`challenge`]** — [`challenge::ChallengeBuilder`] that constructs a
//!   [`::siwe::Message`] embedding the portal-tunnel binding statement, and
//!   [`challenge::verify_siwe`] which synchronously verifies an EIP-191
//!   signature over that message.
//!
//! - **[`binding`]** — [`binding::BindingAttestation`] that ties an Ethereum
//!   address to an ed25519 public key through the SIWE statement field
//!   (SEC-002).
